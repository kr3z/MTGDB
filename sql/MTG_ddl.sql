...
CREATE TABLE `CardFaces` (
  ...
  `oracle_text` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `Cards` (
  ...
  `card_id` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci GENERATED ALWAYS AS (upper(concat(`name`,ifnull(`oracle_id`,'')))) VIRTUAL,
